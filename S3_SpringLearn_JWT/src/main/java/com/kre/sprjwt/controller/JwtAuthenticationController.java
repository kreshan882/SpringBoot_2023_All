...
import com.kre.sprjwt.jwtutility.JwtTokenUtil;
import com.kre.sprjwt.model.JwtRequest;
import com.kre.sprjwt.model.JwtResponse;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
        ...
        final UserDetails userDetails = userSer.loadUserByUsername(authenticationRequest.getUsername());
